...
print(f"Jugador 1 tiró: {dado1_j1} y {dado2_j1} - Total: {total_j1}")
print(f"Jugador 2 tiró: {dado1_j2} y {dado2_j2} - Total: {total_j2}")
...
if total_j1 > total_j2:
    ...
    if max_j1 > max_j2:
        print("Gana el Jugador 1 por sacar el valor más alto")
    elif max_j2 > max_j1:
        print("Gana el Jugador 2 por sacar el valor más alto")
    else:
        print("Empate")
