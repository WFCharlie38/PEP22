...
#En primer lugar el programa tendrá que mostrar un mensaje por pantalla al usuario para preguntarle qué opción desea elegir. Por ejemplo:
# 1. Piedra
# 2. Papel
# 3. Tijera
...
if opcion_usuario not in [1, 2, 3]:
    ...
    print(f"Tú elegiste: {opciones[opcion_usuario]}")
    print(f"La computadora eligió: {opciones[opcion_maquina]}")
